...
class StereoPublisher(Node):
    def __init__(self):
        ...
        # Publicadores para las imágenes izquierda y derecha
    ...
    def process_loop(self):
        while rclpy.ok():
            ...
            try:
                # Esperar por frames sincronizados
            ...
            # Alinear frames de profundidad y color
            ...
            # Convertir frames a arrays de NumPy
